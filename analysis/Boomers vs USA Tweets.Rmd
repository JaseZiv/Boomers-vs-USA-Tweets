...
bball_tweets <- bball_tweets %>% 
  select(status_id, created_at, screen_name, text, source, display_text_width, reply_to_status_id, favorite_count, retweet_count, hashtags, media_type, mentions_screen_name, lang, followers_count, verified)
